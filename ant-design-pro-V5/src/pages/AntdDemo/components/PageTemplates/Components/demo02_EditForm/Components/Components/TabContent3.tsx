...
import { ProTable, ActionType, ProColumns, ProCard, FooterToolbar, ProFormInstance } from '@ant-design/pro-components'
...
// 使用 observer 讓此元件可以響應 MobX store 的變化
export default observer(TabContent3)
