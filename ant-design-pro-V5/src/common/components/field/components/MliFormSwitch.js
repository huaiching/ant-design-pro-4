...
var MliFormSwitch = function MliFormSwitch(props) {
  ...
  var columnValue = Form.useWatch(columnName === null || columnName === void 0 ? void 0 : columnName.split('.'), formInstance) ? formatMessage({
    id: 'common.yes'
  }) : formatMessage({
    id: 'common.no'
  });
    ...
    children: /*#__PURE__*/_jsx(Form.Item, _objectSpread(_objectSpread({
      ...
      children: /*#__PURE__*/_jsxs(Row, {
        ...
        children: [/*#__PURE__*/_jsx(Form.Item, _objectSpread(_objectSpread({
          ...
          }) : /*#__PURE__*/_jsx(Switch, _objectSpread({}, defaultProps.fieldProps))
        })), props.children]
      })
    }))
  }));
