...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } /* eslint-disable no-continue */ /* eslint-disable guard-for-in */ /* eslint-disable no-restricted-syntax */
...
function primitive(schemaParams, propsName) {
  ...
  var value = _primitives.default["".concat(type, "_").concat(format || getDateByName(propsName))] || _primitives.default[type];
...
var OpenAPIGeneratorMockJs = /*#__PURE__*/_createClass(function OpenAPIGeneratorMockJs(_openAPI) {
  ...
  this.sampleFromSchema = (0, _memoizee.default)(this.sampleFromSchema);
});
var _default = exports.default = OpenAPIGeneratorMockJs;