...
exports.formatApiInfo = void 0;
exports.formatParamsForYFH = formatParamsForYFH;
exports.writeFile = exports.stripDot = exports.prettierFile = exports.mkdir = exports.getTagName = exports.getAbsolutePath = void 0;
...
var getAbsolutePath = exports.getAbsolutePath = function getAbsolutePath(filePath) {
  if (filePath && !_path.default.isAbsolute(filePath)) {
    return _path.default.join(process.cwd(), filePath);
  }
  return filePath;
};
var mkdir = exports.mkdir = function mkdir(dir) {
  if (!_fs.default.existsSync(dir)) {
    mkdir(_path.default.dirname(dir));
    _fs.default.mkdirSync(dir);
  }
};
var prettierFile = exports.prettierFile = function prettierFile(content) {
  var result = content;
  var hasError = false;
  try {
...
var writeFile = exports.writeFile = function writeFile(folderPath, fileName, content) {
  var filePath = _path.default.join(folderPath, fileName);
  ...
  _fs.default.writeFileSync(filePath, prettierContent, {
    encoding: 'utf8'
  });
  return hasError;
};
var getTagName = exports.getTagName = function getTagName(name) {
  ...
  if (result.length === 5) {
    return result[2] + (0, _lodash.upperFirst)(result[3]);
  }
  return name;
};
 ...
 */
var formatApiInfo = exports.formatApiInfo = function formatApiInfo(apiInfo) {
 ...
 */
function formatParamsForYFH(params) {
  ...
  Object.keys(params).forEach(function (name) {
    ...
    if (nameListLength === 1) {
      ...
      var keyChildKey = (0, _lodash.camelCase)(nameList[1]);
    ...
    paramsObject[key].name = (0, _lodash.camelCase)(key);
  });
...
var stripDot = exports.stripDot = function stripDot(str) {
