...
function DragSortTable(props) {
  ...
  var DragHandle = (0, _react.useMemo)(function () {
    return function (dragHandleProps) {
      ...
      var defaultDom = /*#__PURE__*/(0, _jsxRuntime.jsx)(_icons.HolderOutlined, _objectSpread(_objectSpread({}, rest), {}, {
  ...
  // 使用自定義 hooks 獲取拖拽相關組件的 components 集合
  ...
  return wrapSSR( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Table.default, _objectSpread(_objectSpread({}, otherProps), {}, {
