...
var MliFormTextArea = function MliFormTextArea(props) {
  ...
  var defaultProps = (0, _lodash.merge)({
    ...
    formItemProps: {
      normalize: function normalize(val) {
        return props.toDBC ? (0, _utils.toDBC)(val) : val;
      }
    }
  }, props);
  if (props.required) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.ProFormTextArea, _objectSpread({
    colProps: {
      span: colSpan !== null && colSpan !== void 0 ? colSpan : 6
    },
...
var _default = exports.default = MliFormTextArea;