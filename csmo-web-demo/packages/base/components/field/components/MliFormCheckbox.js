...
var MliFormCheckboxGroup = function MliFormCheckboxGroup(props) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.ProFormCheckbox.Group, _objectSpread({
    colProps: {
...
var MliFormCheckbox = function MliFormCheckbox(props) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.ProFormCheckbox, _objectSpread({
    colProps: {
      span: colSpan !== null && colSpan !== void 0 ? colSpan : 8
    },
    name: columnName === null || columnName === void 0 ? void 0 : columnName.split('.'),
...
var WrappedMliFormCheckbox = MliFormCheckbox;
WrappedMliFormCheckbox.Group = MliFormCheckboxGroup;
var _default = exports.default = WrappedMliFormCheckbox;