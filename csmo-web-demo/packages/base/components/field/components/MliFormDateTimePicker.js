...
var MliFormDateTimePicker = function MliFormDateTimePicker(props) {
  ...
  defaultProps.formItemProps = _objectSpread({
    getValueProps: function getValueProps(value) {
      return {
        value: value && (typeof value === 'string' ? (0, _dayjs.default)(value, formatMessage({
          id: 'common.dateTime'
        })) : value)
      };
    }
  }, defaultProps.formItemProps);
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.ProFormDateTimePicker, _objectSpread({
    colProps: {
...
var _default = exports.default = MliFormDateTimePicker;