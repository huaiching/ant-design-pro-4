...
var MliFormCascader = function MliFormCascader(props) {
  ...
  var defaultProps = (0, _lodash.cloneDeep)((0, _omit.default)(props, ['moduleName', 'columnName', 'colSpan']));
  if (props.required) {
    var requiredRule = {
      required: true,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_proComponents.ProFormCascader, _objectSpread({
    colProps: {
...
var _default = exports.default = MliFormCascader;