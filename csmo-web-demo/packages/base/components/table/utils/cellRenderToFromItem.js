...
var CellRenderFromItem = function CellRenderFromItem(props) {
  ...
  var InlineItem = (0, _react.useCallback)(function (_ref3) {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_proUtils.InlineErrorFormItem, _objectSpread(_objectSpread({
      popoverProps: {
  ...
  var generateFormItem = (0, _react.useCallback)(function () {
    var _ref4, _ref5;
    var formItemProps = _objectSpread({}, _proUtils.getFieldPropsOrFormItemProps.apply(void 0, [columnProps === null || columnProps === void 0 ? void 0 : columnProps.formItemProps].concat(_toConsumableArray(needProps))));
    ...
    var fieldDom = /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.ProFormField, _objectSpread({
      cacheForSwr: true,
      name: formItemName,
      proFormFieldKey: key,
      ignoreFormItem: true,
      fieldProps: _proUtils.getFieldPropsOrFormItemProps.apply(void 0, [columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps].concat(_toConsumableArray(needProps)))
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(InlineItem, _objectSpread(_objectSpread({}, formItemProps), {}, {
      children: fieldDom
    }), formItemName.join('-'));
...
function cellRenderToFromItem(config) {
  ...
  if ((!valueType || ['textarea', 'text'].includes(valueType.toString())) && !(columnProps !== null && columnProps !== void 0 && columnProps.valueEnum) && config.mode === 'read') {
    ...
    return hideColumnToolTip ? domtext : /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Tooltip, {
      title: domtext,
  ...
  if (config.mode !== 'edit') {
    var field = /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.ProFormField, _objectSpread({
      mode: "read",
      ignoreFormItem: true,
    ...
    var _className = columnProps !== null && columnProps !== void 0 && columnProps.ellipsis ? 'mli-ellipsis mli-table-item-content' : 'mli-table-item-content';
    if (valueType == 'digit' || valueType === 'money') {
      _className += ' mli-table-item-content-number';
    }
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
      children: hideColumnToolTip ? field : /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Tooltip, {
        title: field,
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
          className: "".concat(_className),
          children: field
        })
      })
    });
  }
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(CellRenderFromItem, _objectSpread(_objectSpread({}, config), {}, {
