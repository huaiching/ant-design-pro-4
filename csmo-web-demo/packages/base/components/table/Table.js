...
var _clearTableSessionStorage = require("../table/utils/clearTableSessionStorage");
...
function TableRender(props) {
  ...
  var baseTableDom = /*#__PURE__*/(0, _jsxRuntime.jsx)(_proForm.GridContext.Provider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Table, _objectSpread(_objectSpread({}, getTableProps()), {}, {
      rowKey: rowKey
    }))
  });
  ...
  var tableContentDom = (0, _react.useMemo)(function () {
    if (props.editable && !props.name) {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
        children: [toolbarDom, toolbarAfterDom, alertDom, /*#__PURE__*/(0, _react.createElement)(_proForm.default, _objectSpread(_objectSpread({}, (_props$editable = props.editable) === null || _props$editable === void 0 ? void 0 : _props$editable.formProps), {}, {
  ...
  propsCardProps === false || notNeedCardDom === true || !!props.name ? tableContentDom : /*#__PURE__*/(0, _jsxRuntime.jsx)(_proCard.default, _objectSpread(_objectSpread({
    ghost: props.ghost,
    bordered: (0, _utils2.isBordered)('table', cardBordered),
    style: {
      margin: 0
    },
  ...
  var proTableDom = /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    className: (0, _classnames.default)(className, _defineProperty({}, "".concat(defaultClassName, "-polling"), action.pollingLoading)),
    style: style,
  ...
  var renderEmpty = function renderEmpty() {
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Empty, {
...
var ProTable = function ProTable(props) {
  ...
  var _useStyle = (0, _style2.useStyle)(props.defaultClassName),
    wrapSSR = _useStyle.wrapSSR,
    hashId = _useStyle.hashId;
  var className = (0, _classnames.default)(defaultClassName, propsClassName, hashId, 'mli-table', "".concat(moduleName, "-table"));
  ...
  var _useReactIntl2 = (0, _reactIntl.useIntl)(),
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              transformParams = (_filterUsefulParams = (0, _.filterUsefulParams)(searchParamsTransform === null || searchParamsTransform === void 0 ? void 0 : searchParamsTransform(formSearch, (0, _utils.sortToArray)(proSort)))) !== null && _filterUsefulParams !== void 0 ? _filterUsefulParams : null;
              _context.next = 5;
  ...
  (0, _proUtils.useDeepCompareEffect)(function () {
    ...
    if (props.request && !(0, _lodash.isEmpty)(params) && action.dataSource && !(0, _lodash.isEqual)(action.dataSource, defaultData) && (action === null || action === void 0 || (_action$pageInfo = action.pageInfo) === null || _action$pageInfo === void 0 ? void 0 : _action$pageInfo.current) !== 1) {
      action.setPageInfo({
        current: 1
      });
    }
  ...
  var resetSearch = function resetSearch() {
    ...
    // sessionStorage.removeItem(`${moduleName}_${location.pathname}`)
    sessionStorage.removeItem("".concat(moduleName));
    sessionStorage.removeItem("".concat(_clearTableSessionStorage.TABLE_SESSION_KEY, "_").concat(moduleName, "_").concat(location.pathname));
    sessionStorage.removeItem("".concat(_clearTableSessionStorage.COLUMN_SESSION_KEY, "_").concat(moduleName, "_").concat(location.pathname));
  };
  (0, _utils2.useActionType)(actionRef, action, {
    ...
    setSearchFormValues: function setSearchFormValues() {
      ...
      setFormSearch((0, _proUtils.omitUndefined)(values));
    },
    ...
    getSearchFormValues: function getSearchFormValues() {
      ...
      return (0, _proUtils.omitUndefined)(values);
    },
    ...
    getSorts: function getSorts() {
      return (0, _utils.sortToArray)(proSort);
    },
  ...
  var tableColumn = (0, _react.useMemo)(function () {
    ...
    var columns = (0, _genProColumnToColumn.genProColumnToColumn)({
    ...
    var columnsFields = columns.map(function (item) {
      var _item$valueType;
      var columnKey = (0, _utils2.genColumnKey)(item.key || item.columnName, item.index);
      var config = counter.columnsMap[columnKey];
      if (config && config.show === false) {
        return false;
      }
  ...
  return wrapSSR( /*#__PURE__*/(0, _jsxRuntime.jsx)(TableRender, _objectSpread(_objectSpread({}, props), {}, {
    name: isEditorTable,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Provide.Container, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_proProvider.ProConfigProvider, {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(ErrorComponent, {
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(ProTable, _objectSpread({
