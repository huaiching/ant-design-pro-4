// src/pages/DownloadFileAppendix/index.tsx
...
const DownloadFileAppendixPage: React.FC = () => {
  return (
    <PageContainer title="附錄 - 下載後端API產出的檔案">
      <Typography>

        <Paragraph>
          對於 複雜的報表檔案，通常會由 後端 產生bye[] 格式的二進位檔案 (excel, word, pdf……)<br />
          如果 想要在前端 讓使用者可以下載這類的檔案，<br />
          通常 會透過 Button 來呼叫 後端的檔案API 取得 檔案的資料流<br />
...
export default DownloadFileAppendixPage;