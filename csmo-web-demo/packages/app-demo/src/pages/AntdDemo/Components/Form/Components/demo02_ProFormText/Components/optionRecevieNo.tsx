...
const OptionReceiveNo: React.FC<Props> = (props) => {

  const { formRef, showModal, setShowModal, handleValueChange } = props
        ...
        tableAlertOptionRender={({
          ...
          return (
            <Button type='link' onClick={() => {
              formRef.current?.setFieldValue('receiveNo', selectedRowKeys[0])
              handleValueChange()   // 呼叫 表單值變更處理
              setShowModal(false)
            }}>
              確定
            </Button>
