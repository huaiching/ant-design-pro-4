...
import editGuard from '@mli-csmo/app-common/src/util/popover/EditGuard'
import AlertEditMode from '@mli-csmo/app-common/src/util/popover/EditMode'
...
const EditGuardOperation: React.FC = () => {
  ...
  return (
    <>
      {editMode && <AlertEditMode onClose={() => setEditMode(false)} />}
...
export default EditGuardOperation